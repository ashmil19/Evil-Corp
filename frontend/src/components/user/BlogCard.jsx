...
const BlogCard = ({blog}) => {
    ...
    return (
        <div className="w-full h-36 flex shadow-md cursor-pointer" >
            <div className=" h-full w-5/6">
                ...
                <div className=" text-sm h-3/6 w-full p-2 overflow-hidden break-words overflow-ellipsis">
                    ...
                    {blog?.description?.length > maxLength && <span className='underline text-blue-600 text-verySmall-1' onClick={()=>navigate("/user/blogDetails", { state: { blogId: blog._id, prevLocation: location } })}>Read More...</span>}
                    </div>
            </div>
