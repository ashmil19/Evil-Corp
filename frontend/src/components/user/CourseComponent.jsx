...
function CourseComponent({className}) {
    return (
        <div className={className ? className : 'h-64 w-full md:w-2/4 cursor-pointer hvr-grow shadow-lg'}>
            ...
            <div className='h-1/3 flex flex-col gap-2 items-start justify-center pl-6'>
                ...
                <div className='text-verySmall md:text-xs font-medium w-full '>Cyber Security Training for Absolute Beginners</div>
            </div>
        </div>
    )
}
