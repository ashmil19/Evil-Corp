...
const TeacherCourseCard = () => {
  return (
    <div className='h-56 w-64'>
        <div className="h-3/4 w-full bg-gray-400 rounded-t-lg bg-cover bg-center cursor-pointer" >
            <img className="w-full h-full object-cover rounded-t-lg" src={profilePic1} alt="" />
        </div>
